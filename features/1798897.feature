...
Feature: Create thank-you page
  ...
  Scenario: Note and contact information
    ...
    And I should see 'Pokud budete mít zájem o zaslání výsledků tohoto průzkumu, vypište prosím Vaši emailovou adresu. Výsledky Vám budou zaslány po závěrečném zpracování dat. Průzkum je zcela anonymní, Vaše emailová adresa nebude použita pro žádné jiné účely.'
